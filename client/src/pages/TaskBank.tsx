  ...
  return (
    <div className="theme-page min-h-screen">
      ...
      <main className="container py-8 sm:py-12">
        <TutorTelegramBanner />
        <section className="mt-8 flex flex-col gap-5 border-b border-white/9 pb-7 sm:flex-row sm:items-end sm:justify-between">
          <div>

...
import { BookOpenCheck, ChartNoAxesColumnIncreasing, ClipboardList, ClipboardPlus, Compass, FileCheck2, Home, Image, Inbox, Library, Menu, Moon, Settings, ShieldCheck, SlidersHorizontal, Sun } from "lucide-react";

...
import { BookOpenCheck, ChartNoAxesColumnIncreasing, ClipboardList, ClipboardPlus, Compass, FileCheck2, Home, Image, Inbox, Library, Menu, Moon, PencilLine, Settings, ShieldCheck, SlidersHorizontal, Sun, KeyRound, ListOrdered } from "lucide-react";
...
const adminLinks = [
  ...
  { href: "/admin/sort", label: "Сортировка", icon: ListOrdered },
...
export function PlatformHeader() {
  ...
  const accountLinks = [
    ...
    { href: "/workspace", label: "Кабинет", icon: ClipboardList },

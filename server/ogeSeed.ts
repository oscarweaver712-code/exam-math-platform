...
/**
 * Canonical КИМ structure of ОГЭ 2026 in mathematics.
 *
 * Titles follow the official specification in `research/fipi-2026/spec.txt`
 * («Обобщённый план варианта КИМ ОГЭ 2026 года по МАТЕМАТИКЕ»). The
 * specification states one identical requirement for tasks 15–18, so their
 * topical split here follows the demo variant convention rather than the
 * specification text; classification code must not treat 15–18 as separable
 * by metadata alone.
 */
const FULL_OGE_KIM_TYPES = [
  ["1", "Практическая задача: план и величины", "part1"], ["2", "Практическая задача: данные условия", "part1"], ["3", "Практическая задача: расчёт по условию", "part1"], ["4", "Практическая задача: выбор варианта", "part1"], ["5", "Таблицы и диаграммы", "part1"],
  ["6", "Действия с числами", "part1"], ["7", "Числа на координатной прямой", "part1"], ["8", "Преобразование выражений", "part1"], ["9", "Уравнения и неравенства", "part1"], ["10", "Вероятность", "part1"], ["11", "Графики функций", "part1"], ["12", "Расчёты по формулам", "part1"],
  ["13", "Неравенства на координатной прямой", "part1"], ["14", "Последовательности и прогрессии", "part1"], ["15", "Геометрия: треугольники", "part1"], ["16", "Геометрия: окружность", "part1"], ["17", "Геометрия: четырёхугольники и площади", "part1"], ["18", "Геометрия: фигуры на клетчатой бумаге", "part1"], ["19", "Истинные и ложные высказывания", "part1"],
  ["20", "Уравнения и неравенства: развёрнутый ответ", "part2"], ["21", "Текстовая задача", "part2"], ["22", "Графики функций: развёрнутый ответ", "part2"], ["23", "Геометрия: вычисление", "part2"], ["24", "Геометрия: доказательство", "part2"], ["25", "Геометрия: высокий уровень", "part2"],
] as const;
